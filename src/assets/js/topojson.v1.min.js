  ...
  function r(n, r, e) {
    ...
    function f(n) {
      "GeometryCollection" === n.type
        ? n.geometries.forEach(f)
        : n.type in l && ((a = n), l[n.type](n.arcs));
    }
    var c = [];
  ...
  function e(r, e) {
    ...
    return (
      e.forEach(function (n) {
        "Polygon" === n.type
          ? o(n.arcs)
          : "MultiPolygon" === n.type && n.arcs.forEach(o);
      }),
  ...
  function u(n, t) {
    ...
    function c(n) {
      ...
      return "GeometryCollection" === t
        ? { type: t, geometries: n.geometries.map(c) }
        : t in l
        ? { type: t, coordinates: l[t](n) }
        : null;
    }
    var a = g(n.transform),
      s = n.arcs,
      ...
      for (var a = o[f], s = a.length, l = 0; s > l; ++l)
        for (var h = l + 1; s > h; ++h) {
          var p,
            v = a[l],
            g = a[h];
          (p = i[v])[(f = c(p, g))] !== g && p.splice(f, 0, g),
            (p = i[g])[(f = c(p, v))] !== v && p.splice(f, 0, v);
        }
    return i;
  }
  function s(n, t) {
    ...
    for (
      ...
      e[1][2] < f ? (e[1][2] = f) : (f = e[1][2]),
        c && ((c.next = a), (c[2] = e[2]), r(c)),
        a && ((a.previous = c), (a[0] = e[0]), r(a));
    }
    return (
      n.arcs.forEach(function (n) {
        n.forEach(i);
    ...
    function t(n, t) {
      for (;;) {
        var r = (t + 1) << 1,
          ...
          f = e[u];
        if (
          (o > i && p(e[i], f) < 0 && (f = e[(u = i)]),
          o > r && p(e[r], f) < 0 && (f = e[(u = r)]),
          u === t)
        )
          break;
